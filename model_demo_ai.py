...
from ai_model import ContactPredictor
...
all_impulse_predictor = ContactPredictor()  # Specify input dimension
...
all_impulse_predictor.load_state_dict(clean_state_dict)
all_impulse_predictor.eval()
